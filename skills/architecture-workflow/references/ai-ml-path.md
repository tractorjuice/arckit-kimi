...
|---------|-----------|-------------|
| `/skill:arckit-datascout` | Discover training data sources, validate data quality | Before data-model (if not already in base path) |
...
| Command | Rationale | Insert After |
|---------|-----------|-------------|
| `/skill:arckit-mlops` | ML model lifecycle: training pipelines, model registry, serving, monitoring, drift detection | After `/skill:arckit-devops` |
...
| Command | Rationale | Insert After |
|---------|-----------|-------------|
| `/skill:arckit-ai-playbook` | UK Government AI Playbook compliance (10 principles) | After `/skill:arckit-tcop` |
| `/skill:arckit-atrs` | Algorithmic Transparency Recording Standard (mandatory for public-facing algorithmic systems) | After `/skill:arckit-ai-playbook` |

#### Defence Base Path

| Command | Rationale | Insert After |
|---------|-----------|-------------|
| `/skill:arckit-jsp-936` | MOD AI Assurance (JSP 936) — risk classification and approval pathway | After `/skill:arckit-mod-secure` |

#### Standard Base Path

| Command | Rationale | Insert After |
|---------|-----------|-------------|
| `/skill:arckit-ai-playbook` | AI Playbook principles are good practice even outside UK Government | Optional, after quality checks |
...
- **Training data**: Use `/skill:arckit-datascout` to identify and evaluate training data sources
