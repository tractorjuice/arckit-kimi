...
- **PRIN** (Architecture Principles, in 000-global) — Extract: Guiding principles, decision framework, technology standards
  - If missing: STOP and ask user to run `/skill:arckit-principles` first. The Preliminary ADM must be grounded in architecture principles.
...
> **Tip**: Users can customise templates with `/skill:arckit-customize adm-preliminary`
...
3. Begin Phase A (Architecture Vision refinement): `/skill:arckit-business-capability-map`
...
7. **Integration with Other Commands**:
   - ADMP feeds into: `/skill:arckit-business-capability-map` (Phase A — Business Architecture), `/skill:arckit-gap-analysis` (Phase E — Opportunities & Solutions)
   - ADMP is informed by: `/skill:arckit-principles`, `/skill:arckit-stakeholders`, `/skill:arckit-strategy`
...
- `/skill:arckit-business-capability-map` -- Map business capabilities within the defined scope
- `/skill:arckit-gap-analysis` -- Perform gap analysis based on scope and vision
