...
4. **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize agent-integration`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-agent-integration` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/skill:arckit-agent-integration` command
**Generated on**: {DATE}
...
User: `/skill:arckit-agent-integration Design integration for the research swarm in project 003`
...
- **Output**: Feeds into `/skill:arckit-agent-governance` (governance for multi-agent orchestration)
- **Output**: Feeds into `/skill:arckit-agent-security` (securing inter-agent communication)
- **Output**: Feeds into `/skill:arckit-agent-maturity` (maturity assessment of integration capabilities)
...
- Run `/skill:arckit-agent-governance` to apply governance to multi-agent orchestration
- Run `/skill:arckit-agent-security` to secure inter-agent communication
```
...
- `/skill:arckit-agent-governance` -- Apply governance to multi-agent orchestration
- `/skill:arckit-agent-security` -- Secure inter-agent communication
