...
4. **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize agent-inventory`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-agent-inventory` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/skill:arckit-agent-inventory` command
**Generated on**: {DATE}
...
- Suggested next steps (e.g., "Run `/skill:arckit-agent-security` to assess security posture" or "Run `/skill:arckit-agent-design` for new agent architecture")

## Example Usage

User: `/skill:arckit-agent-inventory Catalog all AI agents in the data processing pipeline`
...
- **Output**: Feeds into `/skill:arckit-agent-design` (architecture for new or modified agents based on inventory gaps)
- **Output**: Feeds into `/skill:arckit-agent-security` (security assessment for each inventoried agent)
- **Output**: Feeds into `/skill:arckit-agent-governance` (oversight framework built on inventory)
- **Output**: Feeds into `/skill:arckit-agent-integration` (integration patterns between inventoried agents)
- **Output**: Feeds into `/skill:arckit-agent-maturity` (maturity assessment across all agents)
...
- Run `/skill:arckit-agent-security` to assess security posture for inventoried agents
- Run `/skill:arckit-agent-design` to design architecture for new or modified agents
- Run `/skill:arckit-agent-governance` to establish oversight frameworks
```
...
- `/skill:arckit-agent-design` -- Design architecture for new or modified agents
- `/skill:arckit-agent-security` -- Assess security posture for inventoried agents
