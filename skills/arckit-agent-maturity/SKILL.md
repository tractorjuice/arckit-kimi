...
> **Tip**: Users can customize templates with `/skill:arckit-customize agent-maturity`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-agent-maturity` command | [PENDING] | [PENDING] |
```

**Populate Generation Metadata Footer**:

```markdown
**Generated by**: ArcKit `/skill:arckit-agent-maturity` command
...
3. Create detailed plans for top priorities: `/skill:arckit-agent-design`
4. Strengthen governance for low-maturity dimensions: `/skill:arckit-agent-governance`
...
- `/skill:arckit-agent-design` -- Design improvements based on maturity gaps
- `/skill:arckit-agent-governance` -- Strengthen governance based on maturity assessment
