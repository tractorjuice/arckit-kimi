...
3. **Read existing artifacts from the project context:**
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize ai-playbook`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-ai-playbook` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-ai-playbook` command
...
User: `/skill:arckit-ai-playbook Assess AI Playbook compliance for benefits eligibility chatbot using GPT-4`
