...
> **Tip**: Users can customize templates with `/skill:arckit-customize analyze`
...
- Project has requirements but no stakeholder analysis document (RECOMMENDED to run `/skill:arckit-stakeholders`)
...
- Project has requirements but no risk register document (RECOMMENDED to run `/skill:arckit-risk`)
...
- Project has requirements but no SOBC (RECOMMENDED for major investments to run `/skill:arckit-sobc`)
...
- Project has DR-xxx requirements but no data model (RECOMMENDED to run `/skill:arckit-data-model`)
...
- Project for MOD but no SbD assessment (MANDATORY to run `/skill:arckit-mod-secure`)
...
1. **If CRITICAL issues exist**: ❌ **DO NOT PROCEED** with implementation/procurement until resolved.
   - Run: `/skill:arckit-requirements` to fix requirements issues
   - Run: `/skill:arckit-hld-review` to address design gaps
   - Run: `/skill:arckit-ai-playbook` (if AI system) to complete mandatory assessments
...
- `/skill:arckit-principles` - Create/update architecture principles
- `/skill:arckit-stakeholders` - Analyze stakeholder drivers, goals, conflicts (RECOMMENDED)
- `/skill:arckit-risk` - Create risk register using Orange Book framework (RECOMMENDED)
- `/skill:arckit-sobc` - Create Strategic Outline Business Case using Green Book 5-case model (RECOMMENDED for major investments)

**Requirements & Design**:
- `/skill:arckit-requirements` - Refine requirements to address ambiguity/gaps
- `/skill:arckit-data-model` - Create data model with ERD, GDPR compliance (RECOMMENDED if DR-xxx exist)
- `/skill:arckit-hld-review` - Re-review HLD after addressing issues
- `/skill:arckit-dld-review` - Re-review DLD after addressing issues

**UK Government Compliance**:
- `/skill:arckit-tcop` - Complete TCoP assessment for UK Gov projects
- `/skill:arckit-ai-playbook` - Complete AI Playbook assessment for AI systems
- `/skill:arckit-atrs` - Generate ATRS record for algorithmic tools
- `/skill:arckit-secure` - UK Government Secure by Design review

**MOD Compliance**:
- `/skill:arckit-mod-secure` - MOD Secure by Design assessment with CAAT (MANDATORY for MOD projects)

**Vendor Procurement**:
- `/skill:arckit-sow` - Generate statement of work for RFP
- `/skill:arckit-evaluate` - Update vendor evaluation criteria

**Analysis & Traceability**:
- `/skill:arckit-traceability` - Generate/update traceability matrix
- `/skill:arckit-analyze` - Re-run this analysis after fixes

### Re-run Analysis

After making changes, re-run analysis:
```bash
/skill:arckit-analyze
```text
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-analyze` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-analyze` command
...
- Run `/skill:arckit-analyze` after major changes to requirements, designs, or assessments
- Ideal times to run:
...
- `/skill:arckit-principles` - Create/update architecture principles
- `/skill:arckit-stakeholders` - Analyze stakeholder drivers and conflicts
- `/skill:arckit-risk` - Create Orange Book risk register
- `/skill:arckit-sobc` - Create Green Book business case

**Requirements & Data**:

- `/skill:arckit-requirements` - Fix requirements issues
- `/skill:arckit-data-model` - Create data model with ERD and GDPR compliance

**Design Reviews**:

- `/skill:arckit-hld-review` - Re-review high-level design
- `/skill:arckit-dld-review` - Re-review detailed design

**UK Government Compliance**:

- `/skill:arckit-tcop` - Complete TCoP assessment
- `/skill:arckit-ai-playbook` - Complete AI Playbook assessment
- `/skill:arckit-atrs` - Generate ATRS record
- `/skill:arckit-secure` - UK Government Secure by Design review

**MOD Compliance**:

- `/skill:arckit-mod-secure` - MOD Secure by Design assessment with CAAT

**Traceability**:

- `/skill:arckit-traceability` - Update traceability matrix
