...
> **Tip**: Users can customise templates with `/skill:arckit-customize architecture-change`
...
### Next Steps
1. Review change request with Architecture Board: `/skill:arckit-architecture-board`
2. Update transition plan for approved changes: `/skill:arckit-transition-architecture`
3. Re-assess gaps after implementation: `/skill:arckit-gap-analysis`
...
7. **Integration with Other Commands**:
   - Architecture Change feeds into: `/skill:arckit-transition-architecture` (update migration plans), `/skill:arckit-gap-analysis` (re-assess after implementation)
   - Architecture Change is informed by: `/skill:arckit-architecture-board` (governance context), BPCM (capability baseline), ADMP (framework)
...
- `/skill:arckit-transition-architecture` -- Update transition plan for approved changes
- `/skill:arckit-gap-analysis` -- Re-assess gaps after change implementation
