...
Next steps:
1. {If personal data: Include DPA from /skill:arckit-at-dsgvo}
2. {If Essential/Important: Include NISG supply clauses from /skill:arckit-at-nisg}
...
```text
/skill:arckit-at-bvergg Austrian procurement for 001 — federal digital identity platform, Auftragswert €1.8M, classical sector, Oberschwellenbereich, processes personal data, Essential entity under NISG

/skill:arckit-at-bvergg BVergG 2018 procurement pack for a municipal water utility SCADA upgrade — Sektorenauftraggeber, Oberschwellenbereich, €3.2M, Essential entity

/skill:arckit-at-bvergg Direct award for a €60K proof-of-concept integration, classical sector, no personal data
```
...
- `/skill:arckit-evaluate` -- Score vendor responses against the award criteria defined in this document *(when Tenders received and ready for evaluation)*
- `/skill:arckit-traceability` -- Link procurement requirements back to functional and non-functional requirements
- `/skill:arckit-at-dsgvo` -- Include GDPR/DPA obligations in procurement documentation where personal data processed *(when Procurement involves processors of personal data)*
- `/skill:arckit-at-nisg` -- Reflect NISG supply chain obligations in vendor security clauses *(when Contracting entity is Essential or Important under NISG)*
