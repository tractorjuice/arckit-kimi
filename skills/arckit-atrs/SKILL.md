...
4. **Read existing artifacts from the project context:**
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize atrs`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-atrs` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-atrs` command
...
User: `/skill:arckit-atrs Generate ATRS record for our benefits eligibility chatbot using GPT-4`
...
- **AI Playbook** - responsible AI deployment (use `/skill:arckit-ai-playbook` first for AI systems)
- **Technology Code of Practice** - broader technology governance (use `/skill:arckit-tcop`)
