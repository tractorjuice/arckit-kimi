...
6. Generate the following sections:
   ...
   - **ArcKit Evidence Integration** — map `/skill:arckit-risk`, `/skill:arckit-traceability`, `/skill:arckit-graph-report`, and `/skill:arckit-maturity-model` outputs to E8 strategy gaps, control evidence, DISP implications, and uplift planning.
...
- The Essential Eight is a **mitigation** framework, not a comprehensive security standard. Recommend `/skill:arckit-au-ism-controls` for the full ISM control applicability statement.
