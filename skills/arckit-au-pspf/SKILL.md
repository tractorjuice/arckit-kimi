...
6. Generate the following sections:
   ...
   - **ArcKit Evidence Integration** — map `/skill:arckit-diagram`, `/skill:arckit-data-model`, `/skill:arckit-servicenow`, `/skill:arckit-risk`, `/skill:arckit-traceability`, `/skill:arckit-graph-report`, and `/skill:arckit-maturity-model` outputs to PSPF outcomes, CMDB ownership, supporting services, annual self-assessment evidence, and remediation tracking.
