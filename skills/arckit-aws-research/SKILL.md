...
```text
**Generated by**: ArcKit `/skill:arckit-aws-research` agent
**Generated on**: {DATE}
...
- **Related commands** — `/skill:arckit-requirements` (input) · `/skill:arckit-research` (cross-cloud comparison) · `/skill:arckit-azure-research` · `/skill:arckit-gcp-research`
...
- `/skill:arckit-diagram` -- Create AWS architecture diagrams
- `/skill:arckit-devops` -- Design AWS CodePipeline CI/CD
- `/skill:arckit-finops` -- Create AWS cost management strategy
- `/skill:arckit-adr` -- Record AWS service selection decisions
