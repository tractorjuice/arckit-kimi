...
```text
**Generated by**: ArcKit `/skill:arckit-azure-research` agent
**Generated on**: {DATE}
...
- `/skill:arckit-diagram` -- Create Azure architecture diagrams
- `/skill:arckit-devops` -- Design Azure DevOps pipeline
- `/skill:arckit-finops` -- Create Azure cost management strategy
- `/skill:arckit-adr` -- Record Azure service selection decisions
