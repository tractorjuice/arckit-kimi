...
- `/skill:arckit-service-assessment` -- GC Digital Standards conformance feeds the broader service assessment evidence base.
- `/skill:arckit-roadmap` -- Identified gaps and remediation actions become roadmap milestones.
