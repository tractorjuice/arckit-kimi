...
- `/skill:arckit-ca-cloud-residency` -- Categorisation and control profile feed the sovereign cloud residency assessment.
- `/skill:arckit-risk` -- Residual security risks and tailoring deviations become entries in the operational risk register.
- `/skill:arckit-adr` -- Material control tailoring or compensating-control decisions warrant Architecture Decision Records.
