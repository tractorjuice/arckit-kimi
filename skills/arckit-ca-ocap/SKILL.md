...
- `/skill:arckit-data-model` -- OCAP-mapped data classifications and access controls feed the data model's stewardship and access policies.
- `/skill:arckit-ca-pia` -- Personal-information processing of Indigenous data inherits the PIA controls plus OCAP-derived restrictions.
- `/skill:arckit-ca-atip` -- ATIP severance design must reflect OCAP access and control determinations for Indigenous datasets.
