...
- `/skill:arckit-ca-gc-digital-standards` -- OLA service equivalence is a baseline expectation under the GC Digital Standards conformance scorecard.
- `/skill:arckit-service-assessment` -- OLA review feeds the service assessment evidence base for bilingualism and active offer.
