...
- `/skill:arckit-risk` -- PIA findings feed the privacy and regulatory entries in the risk register.
- `/skill:arckit-ca-atip` -- Personal-information disclosure register continues into the Access to Information / Privacy Act reconciliation.
- `/skill:arckit-ca-aia` -- Required when automated decision-making touches personal information; the AIA inherits the PIA personal-information inventory.
