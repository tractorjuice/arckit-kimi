...
- `/skill:arckit-evaluate` -- PSPC route selection feeds the vendor evaluation framework's scoring rubric.
- `/skill:arckit-sobc` -- Procurement strategy feeds the Strategic Outline Business Case's procurement and commercial pillars.
