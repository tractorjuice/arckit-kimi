...
| `research-findings` | `/skill:arckit-research` | Technology research findings |
| `risk-register` | `/skill:arckit-risk` | Risk register (Orange Book) |
| `roadmap` | `/skill:arckit-roadmap` | Architecture roadmap |
| `service-assessment-prep` | `/skill:arckit-service-assessment` | GDS Service Standard prep |
| `servicenow-design` | `/skill:arckit-servicenow` | ServiceNow service design |
| `sobc` | `/skill:arckit-sobc` | Strategic Outline Business Case |
| `sow` | `/skill:arckit-sow` | Statement of Work / RFP |
