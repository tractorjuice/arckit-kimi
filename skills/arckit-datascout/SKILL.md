...
```text
**Generated by**: ArcKit `/skill:arckit-datascout` agent
**Generated on**: {DATE}
...
- Next steps (run `/skill:arckit-data-model`, `/skill:arckit-adr`, `/skill:arckit-dpia`)
...
- **No requirements found**: Stop immediately, tell user to run `/skill:arckit-requirements`
...
- `/skill:arckit-data-model` -- Add discovered sources to data model
- `/skill:arckit-research` -- Research data source pricing and vendors
- `/skill:arckit-adr` -- Record data source selection decisions
- `/skill:arckit-dpia` -- Assess third-party data sources with personal data
- `/skill:arckit-diagram` -- Create data flow diagrams
- `/skill:arckit-traceability` -- Map DR-xxx requirements to discovered sources
