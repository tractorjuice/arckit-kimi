...
If the user specified a level (e.g., `/skill:arckit-dfd level 1`), skip this question and proceed directly.
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-dfd` command | [PENDING] | [PENDING] |
```

**Populate Generation Metadata Footer**:

```markdown
**Generated by**: ArcKit `/skill:arckit-dfd` command
...
Next Steps:
- /skill:arckit-dfd level 1 — Decompose into sub-processes (if context diagram)
- /skill:arckit-dfd level 2 — Detail a specific process (if Level 1 exists)
- /skill:arckit-diagram — Generate C4 or deployment diagrams
- /skill:arckit-data-model — Create formal data model from data stores
```
