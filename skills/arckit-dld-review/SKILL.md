...
2. **Read existing artifacts** from the project context:
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize dld-review`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-dld-review` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-dld-review` command
...
User: `/skill:arckit-dld-review Review Acme Payment Solutions DLD for payment gateway`
