...
```markdown
**Generated by**: ArcKit `/skill:arckit-dos` command
...
Reference: `/skill:arckit-traceability` for traceability matrix generation and validation
...
Reference: Generate with `/skill:arckit-diagram`, `/skill:arckit-data-model`
...
- **`/skill:arckit-evaluate`**: Create vendor evaluation framework and scoring
- **`/skill:arckit-hld-review`**: High-Level Design review process for vendor deliverables
- **`/skill:arckit-dld-review`**: Detailed Design review process for vendor deliverables
- **`/skill:arckit-traceability`**: Requirements traceability matrix validation
...
- /skill:arckit-evaluate - Create vendor evaluation framework after receiving proposals
- /skill:arckit-hld-review - Set up HLD review process for vendor deliverables
- /skill:arckit-dld-review - Set up DLD review process for vendor deliverables
- /skill:arckit-traceability - Validate requirements traceability with vendor
