...
Next steps:
1. {If NIS2 overlap: Run /skill:arckit-eu-nis2}
2. {If AI component: Run /skill:arckit-eu-ai-act}
3. Run /skill:arckit-secure for Annex I security controls
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```text
/skill:arckit-eu-cra Assess CRA compliance for an industrial IoT gateway device placed on EU market, connecting factory floor OT equipment to cloud analytics, firmware updateable, classified as Important (Class I) under Annex III

/skill:arckit-eu-cra CRA assessment for 001 — password manager software (SaaS), placed on EU market, subscription model, Class I classification expected

/skill:arckit-eu-cra CRA compliance for an open source network monitoring tool with commercial support contract, assess whether the open source steward exemption applies
```
...
- `/skill:arckit-eu-nis2` -- Map overlapping incident reporting obligations between CRA and NIS2 *(when Product is used by NIS2-scoped entities as part of their critical infrastructure)*
- `/skill:arckit-eu-ai-act` -- Assess AI Act obligations if the product contains an AI system *(when Product with digital elements includes an AI component)*
- `/skill:arckit-secure` -- Implement security controls addressing CRA Annex I essential requirements
