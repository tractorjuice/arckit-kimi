...
Next steps:
1. {If personal data in recommender/ads: Run /skill:arckit-eu-rgpd}
2. {If AI-driven moderation or recommendation: Run /skill:arckit-eu-ai-act}
3. Run /skill:arckit-risk to register DSA gaps
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
- **Recommender systems and AI Act overlap**: Recommender systems may simultaneously fall under DSA (transparency) and AI Act (high-risk if employment/benefits context). Run `/skill:arckit-eu-ai-act` if AI-driven.
...
```text
/skill:arckit-eu-dsa Assess DSA compliance for a French online marketplace (€500M GMV, 8M monthly EU users), hosting third-party seller listings, with recommendation engine and targeted advertising

/skill:arckit-eu-dsa DSA scoping for 001 — social media platform with 60M monthly EU users, Commission designated VLOP, annual systemic risk assessment required

/skill:arckit-eu-dsa DSA compliance for a SaaS hosting service storing user-generated content for B2B clients, no public dissemination — assess hosting obligations
```
...
- `/skill:arckit-eu-rgpd` -- Assess GDPR obligations for personal data processed in recommender systems, advertising, and content moderation *(when Service processes personal data of EU users)*
- `/skill:arckit-eu-ai-act` -- Assess AI Act obligations for recommender systems and automated content moderation *(when Service uses AI for recommendation or content moderation decisions)*
- `/skill:arckit-risk` -- Integrate DSA compliance gaps and systemic risk findings into the risk register *(when VLOP or VLOSE designation applies)*
