...
3. **Read the templates** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize evaluate`
...
User: `/skill:arckit-evaluate Score Acme Payment Solutions proposal for project 001`
...
User: `/skill:arckit-evaluate Compare all vendors for payment gateway project`
