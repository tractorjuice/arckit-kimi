...
Next steps:
1. {If personal data: Run /skill:arckit-fr-rgpd for CNIL compliance}
2. {If cloud: Run /skill:arckit-fr-secnumcloud for cloud doctrine alignment}
3. {If RGS gaps: Run /skill:arckit-secure for security controls}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```text
/skill:arckit-fr-dinum Assess DINUM standards compliance for a citizen-facing tax declaration portal operated by a French ministry, handling personal and financial data, targeting full RGAA compliance and SecNumCloud hosting, with FranceConnect integration

/skill:arckit-fr-dinum DINUM compliance for 001 — regional government digital service, 300 agents, partial cloud migration to OVHcloud

/skill:arckit-fr-dinum Assess digital standards for a French local authority (mairie) citizen portal, under 250 agents, RGAA recommended not mandatory
```
...
- `/skill:arckit-fr-rgpd` -- Assess CNIL-specific GDPR obligations after establishing DINUM compliance baseline *(when Service processes personal data of French residents)*
- `/skill:arckit-fr-secnumcloud` -- Assess SecNumCloud requirements if cloud hosting is involved *(when Cloud hosting required under doctrine cloud de l'État)*
- `/skill:arckit-secure` -- Generate Secure by Design assessment aligned with RGS findings
