...
{If cloud gaps: 4. Run /skill:arckit-fr-secnumcloud for sovereign hosting assessment}
{If GDPR gaps: 5. Run /skill:arckit-eu-rgpd for full data compliance assessment}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```text
/skill:arckit-fr-irn IRN self-assessment for project 001 — AI-driven HR SaaS platform using AWS eu-west-3 with US-based sub-processors

/skill:arckit-fr-irn Assess IRN for a French bank running on Azure with Microsoft 365 across 5,000 employees

/skill:arckit-fr-irn IRN scaffold for a public hospital group — 3 sites, OVHcloud infrastructure, Epic HRIS, strong open-source policy
```
...
- `/skill:arckit-fr-secnumcloud` -- Assess SecNumCloud qualification for sovereign cloud hosting *(when RES-6 (Technological Resilience) or RES-5 (Supply-Chain) reveals critical cloud dependency gaps)*
- `/skill:arckit-eu-rgpd` -- Full GDPR compliance assessment for RES-2 regulatory gaps *(when RES-2 (Economic and Legal Resilience) identifies GDPR compliance gaps)*
- `/skill:arckit-eu-nis2` -- NIS2 compliance assessment for essential/important entity obligations *(when RES-2 or RES-7 identifies NIS2 obligations)*
- `/skill:arckit-fr-anssi` -- ANSSI hygiene assessment for RES-7 cybersecurity gaps *(when RES-7 (Security Resilience) reveals significant gaps)*
- `/skill:arckit-fr-ebios` -- EBIOS risk study for operational resilience gaps *(when RES-4 (Operational Resilience) reveals significant risk management gaps)*
