...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Next steps:
1. Run /skill:arckit-fr-ebios — provides threat context and risk baseline for PSSI Section 2
2. Run /skill:arckit-fr-anssi — assess compliance against the PSSI security baseline
3. Run /skill:arckit-fr-anssi-carto — produce SI cartography to populate PSSI scope
4. {If DR data: Run /skill:arckit-fr-dr — incorporate DR handling rules}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```text
/skill:arckit-fr-pssi Generate PSSI for the French Ministry of Culture IS — 2,000 users across 5 sites, OIV designation (secteur culture), RGS ** target level, mix of cloud and on-premise

/skill:arckit-fr-pssi PSSI for 001 — French regional health agency (ARS), OSE designation under NIS2, handling patient data and public health surveillance, CNIL DPO already appointed

/skill:arckit-fr-pssi PSSI for a private OIV operator in the energy sector — gas transmission network, SCADA-adjacent IS, ANSSI sectoral arrêté énergie applies
```
...
- `/skill:arckit-fr-ebios` -- Conduct an EBIOS risk analysis to populate the PSSI threat context and refine security objectives *(when PSSI threat context requires a formal risk analysis or homologation is required)*
- `/skill:arckit-fr-anssi` -- Assess compliance against ANSSI 42 hygiene measures to populate the PSSI security baseline section *(when PSSI security baseline has not yet been assessed against ANSSI hygiene measures)*
- `/skill:arckit-fr-anssi-carto` -- Produce SI cartography to identify assets and interdependencies referenced in the PSSI scope *(when PSSI scope definition requires a structured cartography of the information system)*
- `/skill:arckit-fr-dr` -- Document DR handling rules as a specific section of the PSSI *(when Organisation processes Diffusion Restreinte information)*
- `/skill:arckit-eu-nis2` -- Align PSSI security measures with NIS2 Article 21 obligations *(when Organisation is an OSE under NIS2)*
