...
Next steps:
1. {If OIV/OSE: Run /skill:arckit-eu-nis2 for NIS2 obligation mapping}
2. Run /skill:arckit-fr-marche-public for procurement documentation
...
```text
/skill:arckit-fr-secnumcloud Assess SecNumCloud compliance for a health data platform at a French regional hospital group (CHR), handling données de santé, potential OSE designation

/skill:arckit-fr-secnumcloud Cloud hosting assessment for 001, ministry platform handling personal and financial data, no OIV designation

/skill:arckit-fr-secnumcloud Evaluate sovereign cloud options for a French local authority (collectivité territoriale) digital services platform, mixed-sensitivity data
```
...
- `/skill:arckit-fr-marche-public` -- Generate procurement documentation once SecNumCloud requirements are defined *(when Cloud provider shortlist and qualification requirements identified)*
- `/skill:arckit-eu-nis2` -- Map OIV/OSE obligations to NIS2 requirements *(when Entity has OIV or OSE designation)*
- `/skill:arckit-risk` -- Integrate SecNumCloud and extraterritorial risks into the risk register
