...
- If NOT found: ERROR "Run /skill:arckit-requirements first to define project needs"
...
- If NOT found: WARN "Consider running /skill:arckit-principles to define cloud governance"
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-gcloud-search` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-gcloud-search` command
...
- **No requirements**: ERROR "Run /skill:arckit-requirements first - need to define service needs"
- **Custom development detected**: ERROR "This is for custom development - use /skill:arckit-dos instead"
...
✅ Use /skill:arckit-dos instead - Digital Outcomes and Specialists
...
Only use /skill:arckit-gcloud-search if you need:
