...
> **Tip**: Users can customize templates with `/skill:arckit-customize glossary`
...
4. Review data model terminology: `/skill:arckit-data-model`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-glossary` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-glossary` command
...
7. **Integration with Other Commands**:
   - Glossary is informed by: `/skill:arckit-requirements`, `/skill:arckit-data-model`, `/skill:arckit-stakeholders`, `/skill:arckit-principles`, `/skill:arckit-sobc`, `/skill:arckit-research`, `/skill:arckit-adr`, `/skill:arckit-strategy`, `/skill:arckit-risk`
   - Glossary feeds into: `/skill:arckit-data-model` (validated entity/attribute names)
...
- `/skill:arckit-data-model` -- Review data model for entity/attribute terminology
