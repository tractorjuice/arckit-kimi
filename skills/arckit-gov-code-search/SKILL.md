...
- Next steps (`/skill:arckit-gov-reuse`, `/skill:arckit-research`)
...
- **Related commands** — `/skill:arckit-gov-reuse` (capability-driven reuse) · `/skill:arckit-gov-landscape` (domain landscape)
...
- `/skill:arckit-gov-reuse` -- Deep reuse assessment of interesting finds
- `/skill:arckit-research` -- Broader market research
- `/skill:arckit-adr` -- Record pattern decisions
