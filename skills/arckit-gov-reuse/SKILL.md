...
```text
**Generated by**: ArcKit `/skill:arckit-gov-reuse` agent
**Generated on**: {DATE}
...
- Next steps (`/skill:arckit-research`, `/skill:arckit-adr`)
...
- **No requirements found**: Stop immediately and tell the user to run `/skill:arckit-requirements` first
...
- **Related commands** — `/skill:arckit-requirements` (input) · `/skill:arckit-research` (build-vs-buy comparison) · `/skill:arckit-gov-code-search` · `/skill:arckit-gov-landscape`
...
- `/skill:arckit-research` -- Feed reuse findings into build vs buy analysis
- `/skill:arckit-adr` -- Record reuse decisions
- `/skill:arckit-requirements` -- Refine requirements based on discovered capabilities
