...
2. **Read Available Documents**:
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize hld-review`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-hld-review` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-hld-review` command
...
User: `/skill:arckit-hld-review Review Acme Payment Solutions HLD for payment gateway project`
