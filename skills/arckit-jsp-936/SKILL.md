...
> **Tip**: Users can customize templates with `/skill:arckit-customize jsp-936`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-jsp-936` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/skill:arckit-jsp-936` command
**Generated on**: {DATE}
