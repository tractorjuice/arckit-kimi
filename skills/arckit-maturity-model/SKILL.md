...
> **Tip**: Users can customize templates with `/skill:arckit-customize maturity-model`
...
If no principles document exists, note this as a gap and recommend running `/skill:arckit-principles` first for full alignment.
...
3. Create phased roadmap for maturity progression: `/skill:arckit-roadmap`
4. Incorporate maturity targets into architecture strategy: `/skill:arckit-strategy`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-maturity-model` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-maturity-model` command
...
7. **Integration with Other Commands**:
   - Maturity model is informed by: `/skill:arckit-principles`, `/skill:arckit-strategy`, `/skill:arckit-requirements`, `/skill:arckit-stakeholders`, `/skill:arckit-risk`, `/skill:arckit-data-model`
   - Maturity model feeds into: `/skill:arckit-roadmap` (phased maturity progression), `/skill:arckit-strategy` (capability targets), `/skill:arckit-risk` (capability gap risks)
...
- `/skill:arckit-roadmap` -- Create phased roadmap based on maturity progression
- `/skill:arckit-strategy` -- Incorporate maturity targets into architecture strategy
