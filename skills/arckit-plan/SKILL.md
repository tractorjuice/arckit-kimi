...
> **Tip**: Users can customize templates with `/skill:arckit-customize plan`
...
|------|----------|----------------|-------------|
| 1-2 | Stakeholder Analysis | `/skill:arckit-stakeholders` | Stakeholder map, drivers, goals |
| 3-4 | User Research | Manual | User needs, pain points |
| 5-6 | Business Requirements | `/skill:arckit-requirements` | BRs with acceptance criteria |
| 7 | Architecture Principles | `/skill:arckit-principles` | 10-15 principles |
| 8 | Initial Business Case | `/skill:arckit-business-case` | Cost/benefit analysis |
| 8 | Initial Risk Register | `/skill:arckit-risk` | Top 10 risks |
...
### Discovery Phase
- Week 1-2: `/skill:arckit-stakeholders` - Stakeholder analysis
- Week 5-6: `/skill:arckit-requirements` - Business Requirements (BRs)
- Week 7: `/skill:arckit-principles` - Architecture principles
- Week 8: `/skill:arckit-business-case` - Initial business case
- Week 8: `/skill:arckit-risk` - Initial risk register

### Alpha Phase
- Week 9-11: `/skill:arckit-requirements` - Detailed requirements (FR, NFR, INT, DR)
- Week 12-15: `/skill:arckit-diagram` - Architecture diagrams (C4)
- Week 11-12: `/skill:arckit-sow` - Generate SOW/RFP (if vendor needed)
- Week 13-15: `/skill:arckit-evaluate` - Vendor evaluation (if applicable)
- Week 18: `/skill:arckit-hld-review` - HLD approval gate
- Week 19: `/skill:arckit-business-case` - Updated business case

### Beta Phase
- Week 25: `/skill:arckit-dld-review` - DLD approval gate
- Week 29-31: `/skill:arckit-analyze` - Quality analysis
- Week 32-33: `/skill:arckit-traceability` - Verify design → code → tests
- If AI: `/skill:arckit-ai-playbook`, `/skill:arckit-atrs` - AI compliance

### Live Phase
- Quarterly: `/skill:arckit-analyze` - Periodic quality reviews
- Quarterly: `/skill:arckit-risk` - Update operational risks
- Annually: `/skill:arckit-business-case` - Track benefits realization
```
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-plan` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-plan` command
...
3. Start Discovery: Run `/skill:arckit-stakeholders`
