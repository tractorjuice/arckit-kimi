...
1. **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize architecture-principles`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-principles` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/skill:arckit-principles` command
**Generated on**: {DATE}
...
9. **Summarize what you created**: After writing, provide a brief summary:
   ...
   - Suggested next steps: "Now run `/skill:arckit-stakeholders` to analyze stakeholder drivers and goals for your project"

## Example Usage

User: `/skill:arckit-principles Create principles for a financial services company focusing on cloud migration`
...
- **Decision Criteria, Not Decisions**: Principles guide technology selection during `/skill:arckit-research` phase, they don't prescribe specific technologies
