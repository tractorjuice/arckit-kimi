...
```text
**Generated by**: ArcKit `/skill:arckit-research` agent
**Generated on**: {DATE}
...
- Next steps (run `/skill:arckit-wardley`, `/skill:arckit-sobc`, `/skill:arckit-sow`)
...
- `/skill:arckit-wardley` -- Create Wardley Map from research evolution positioning
- `/skill:arckit-sobc` -- Feed TCO data into Economic Case
- `/skill:arckit-sow` -- Create RFP from vendor requirements
- `/skill:arckit-hld-review` -- Validate technology choices against HLD
- `/skill:arckit-tenders` -- Ground the buy-market and contract values in real UK award data *(when UK government procurement context)*
