...
- `/skill:arckit-health` -- Check artifact health after finding relevant documents *(when Search revealed potentially stale artifacts)*
- `/skill:arckit-traceability` -- Trace requirements found in search results *(when Search included requirement IDs)*
- `/skill:arckit-impact` -- Analyse impact of changes to found documents *(when User wants to understand change blast radius)*
