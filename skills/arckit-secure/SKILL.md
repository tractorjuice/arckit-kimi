...
1. **Loading the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize secure`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-secure` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-secure` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/skill:arckit-secure` command | [PENDING] | [PENDING] |
```
