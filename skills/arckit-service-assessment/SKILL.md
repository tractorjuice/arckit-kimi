...
> **Tip**: Users can customize templates with `/skill:arckit-customize service-assessment`
...
- [ ] Re-run `/skill:arckit-service-assessment` command weekly to track progress
...
**Weekly**:
- [ ] Re-run `/skill:arckit-service-assessment PHASE=[phase]` to track progress
...
- `/skill:arckit-analyze` - Comprehensive governance quality analysis
- `/skill:arckit-traceability` - Requirements traceability matrix showing evidence chains

**Overlap with TCoP**:
- `/skill:arckit-tcop` - Technology Code of Practice assessment (points 11, 13 overlap)

**Generate Missing Evidence**:
- `/skill:arckit-requirements` - If user stories or NFRs weak
- `/skill:arckit-hld-review` - If architecture decisions not documented
- `/skill:arckit-secure` - If security assessment incomplete
- `/skill:arckit-diagram` - If architecture diagrams missing
- `/skill:arckit-wardley` - If technology strategy not clear
...
**Report Generated by**: ArcKit v{ARCKIT_VERSION} `/skill:arckit-service-assessment` command

**Next Actions**:
1. Review this report with your team
2. Prioritize critical actions in your sprint planning
3. Re-run `/skill:arckit-service-assessment PHASE=[phase]` weekly to track progress
...
```text
/skill:arckit-service-assessment PHASE=alpha DATE=2025-12-15
```

Generates: `projects/001-nhs-appointment/ARC-001-SVCASS-v1.0.md`

```text
/skill:arckit-service-assessment PHASE=beta
```
