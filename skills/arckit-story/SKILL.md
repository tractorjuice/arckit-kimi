...
- **PRIN** (Architecture Principles, in `projects/000-global/`)
  ...
  - If missing: warn user to run `/skill:arckit-principles` first — principles are the foundation of the ArcKit governance framework
...
- Commit messages (which often contain ArcKit command names like "/skill:arckit-requirements")
- Files changed
...
[
  {
    ...
    command: "/skill:arckit-principles",
  ...
  },
  {
    ...
    days_from_start: 3,
    event_type: "Foundation",
    command: "/skill:arckit-stakeholders",
...
|---|------|-----------------|------------|---------|----------|-------------|
| 1 | [DATE] | 0 | Foundation | `/skill:arckit-principles` | ARC-000-PRIN-v1.0.md | Established enterprise architecture principles |
| 2 | [DATE] | [DAYS] | Foundation | `/skill:arckit-stakeholders` | ARC-{PROJECT_ID}-STKE-v1.0.md | Analyzed [N] stakeholders, [M] goals, [P] outcomes |
| ... | ... | ... | ... | ... | ... | ... |
...
> **Tip**: Users can customize templates with `/skill:arckit-customize story`
...
1. **Prerequisites first**: Always check that architecture principles exist before generating a story. The principles command (`/skill:arckit-principles`) is the foundation of the ArcKit governance framework and should be the FIRST command run in any project.
...
/skill:arckit-story Cabinet Office GenAI

# Generate story for project by number
/skill:arckit-story 009
