...
- **PRIN** (Architecture Principles, in 000-global) — Extract: Guiding principles, decision framework, technology standards
  - If missing: STOP and ask user to run `/skill:arckit-principles` first. Strategy must be grounded in principles.
- **STKE** (Stakeholder Analysis) — Extract: Stakeholder drivers, goals, measurable outcomes, conflicts, engagement strategies
  - If missing: STOP and ask user to run `/skill:arckit-stakeholders` first. Strategy must address stakeholder drivers.
...
> **Tip**: Users can customize templates with `/skill:arckit-customize strategy`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-strategy` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-strategy` command
...
4. Create detailed requirements: `/skill:arckit-requirements`
5. Expand roadmap: `/skill:arckit-roadmap`
6. Begin detailed design: `/skill:arckit-diagram`
...
8. **Integration with Other Commands**:
   - Strategy feeds into: `/skill:arckit-requirements` (detailed requirements), `/skill:arckit-roadmap` (expanded timeline), `/skill:arckit-plan` (project delivery)
   - Strategy is informed by: `/skill:arckit-principles`, `/skill:arckit-stakeholders`, `/skill:arckit-wardley`, `/skill:arckit-sobc`, `/skill:arckit-risk`
...
- `/skill:arckit-requirements` -- Create detailed requirements from strategy
- `/skill:arckit-roadmap` -- Expand strategic timeline into detailed roadmap
- `/skill:arckit-diagram` -- Create architecture vision diagrams
