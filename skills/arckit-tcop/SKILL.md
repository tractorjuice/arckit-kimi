...
1. **Loading the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize tcop`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-tcop` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-tcop` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/skill:arckit-tcop` command | [PENDING] | [PENDING] |
```
