...
3. **Optionally**: A matching Kimi skill in `.agents/skills/arckit-community-{name}/SKILL.md`
...
- **Custom** — User-modified copies of official templates via `/skill:arckit-customize` (e.g., `Template Origin: Custom`)
...
- **Kimi Skill**: Generate a matching `/skill:arckit-community-{name}` skill file
