...
2. **Artifacts pre-extracted by hook**:
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/skill:arckit-customize traceability`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/skill:arckit-traceability` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/skill:arckit-traceability` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/skill:arckit-traceability` command | [PENDING] | [PENDING] |
```

## Example Usage

User: `/skill:arckit-traceability Generate traceability matrix for payment gateway project`
