...
- `/skill:arckit-adr` -- Tier-promotion decisions are architecturally significant and warrant an ADR.
- `/skill:arckit-risk` -- Per-tier residual risks feed the project risk register.
