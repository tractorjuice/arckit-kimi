...
- `/skill:arckit-data-model` -- Source-of-truth designations refine entity ownership in the data model.
- `/skill:arckit-uae-data-sharing` -- Records designated as the official source feed downstream data-sharing agreements.
