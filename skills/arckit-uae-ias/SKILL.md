...
- `/skill:arckit-risk` -- IAS gaps and risk-treatment plan feed the project risk register.
- `/skill:arckit-uae-cloud-residency` -- IAS technical controls (T-family) constrain residency and CSP choice.
