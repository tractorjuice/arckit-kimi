...
- `/skill:arckit-risk` -- DPIA outputs feed the risk register's privacy and regulatory entries.
- `/skill:arckit-uae-data-sharing` -- Per-share lawful-basis mapping continues into the data sharing agreement.
- `/skill:arckit-uae-classification` -- PDPL-relevant datasets must be classified appropriately.
