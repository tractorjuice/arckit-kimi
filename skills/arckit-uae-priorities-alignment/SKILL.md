...
- `/skill:arckit-sobc` -- The alignment statement and reuse-vs-build justification feed the Strategic Outline Business Case.
- `/skill:arckit-uae-uaepass` -- Reuse of UAE Pass identified here is detailed in the UAE Pass integration design.
