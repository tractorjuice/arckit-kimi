...
- The project's FSSAFE artefact (if generated by `/skill:arckit-uk-fs-safeguarding`) — the safeguarding
...
**Generated by**: ArcKit `/skill:arckit-uk-fs-ctp-dependency` command
**Generated on**: [DATE]
