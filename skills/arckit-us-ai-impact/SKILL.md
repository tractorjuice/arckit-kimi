...
1. Read prerequisites:
   ...
   - The project's AI RMF artefact (recommended prerequisite — if absent, suggest running `/skill:arckit-us-ai-rmf` first)
...
Minimum-practice gaps drive the AI RMF uplift backlog via `/skill:arckit-us-ai-rmf`. PII-handling AI systems require `/skill:arckit-us-privacy-pia`. Any residual M-24-10 risks — particularly waiver scenarios — should be entered into `/skill:arckit-risk` with the next CAIO review date.
...
- `/skill:arckit-us-ai-rmf` -- The minimum-practice gaps surfaced here drive the AI RMF Govern / Map / Measure / Manage uplift backlog.
- `/skill:arckit-us-privacy-pia` -- Rights-impacting AI systems handling PII require an E-Gov Act §208 PIA.
- `/skill:arckit-risk` -- Residual M-24-10 risks (especially where minimum practices cannot be met) flow into the risk register.
