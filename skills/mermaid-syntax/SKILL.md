...
| ---- | --------- | ------------------------ |
| Flowchart | [flowchart.md](references/flowchart.md) | `/skill:arckit-diagram`, `/skill:arckit-dfd`, `/skill:arckit-roadmap`, `/skill:arckit-plan`, `/skill:arckit-backlog`, `/skill:arckit-strategy`, `/skill:arckit-story`, `/skill:arckit-jsp-936` |
| Sequence Diagram | [sequenceDiagram.md](references/sequenceDiagram.md) | `/skill:arckit-diagram` |
| Class Diagram | [classDiagram.md](references/classDiagram.md) | — |
| State Diagram | [stateDiagram.md](references/stateDiagram.md) | — |
| ER Diagram | [entityRelationshipDiagram.md](references/entityRelationshipDiagram.md) | `/skill:arckit-data-model` |
| Gantt Chart | [gantt.md](references/gantt.md) | `/skill:arckit-roadmap`, `/skill:arckit-plan`, `/skill:arckit-strategy`, `/skill:arckit-story`, `/skill:arckit-presentation` |
| Pie Chart | [pie.md](references/pie.md) | `/skill:arckit-story`, `/skill:arckit-presentation` |
| Mindmap | [mindmap.md](references/mindmap.md) | `/skill:arckit-story` |
| Timeline | [timeline.md](references/timeline.md) | `/skill:arckit-story` |
| Git Graph | [gitgraph.md](references/gitgraph.md) | — |
| Quadrant Chart | [quadrantChart.md](references/quadrantChart.md) | `/skill:arckit-presentation` |
| Requirement Diagram | [requirementDiagram.md](references/requirementDiagram.md) | — |
| C4 Diagram | [c4.md](references/c4.md) | `/skill:arckit-diagram`, `/skill:arckit-presentation` |
