...
### OnlineWardleyMaps (OWM) syntax — for the `/skill:arckit-wardley*` commands
...
- `/skill:arckit-wardley-value-chain` — Decompose user needs into value chains (WVCH artifact)
- `/skill:arckit-wardley` — Create strategic Wardley Maps (WARD artifact)
- `/skill:arckit-wardley-doctrine` — Assess organizational doctrine maturity across 4 phases, 40+ principles (WDOC artifact)
- `/skill:arckit-wardley-gameplay` — Analyze strategic plays from 60+ gameplay patterns with D&D alignment (WGAM artifact)
- `/skill:arckit-wardley-climate` — Assess 32 climatic patterns across 6 categories with prediction horizons (WCLM artifact)
